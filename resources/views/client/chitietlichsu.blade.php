...
<div class="container mt-5">
     <div class=" mb-3">
        <small class="breadcrumb" style="gap:4px; font-size:100%;">
            <a href="/">Trang chủ</a> <span>/</span> <span> <a href="{{ url()->previous() }}">Đặt hàng</a></span>/ <span> <a href="{{ url()->previous() }}"> lịch sử đặt hàng </a></span> / <span>chi tiết phiếu đặt {{ $ctdat[0]->idPhieuDat }}</span>
        </small>
    </div>
