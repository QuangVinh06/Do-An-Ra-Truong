    ...
    <div class="container-fluid py-4">
       <div class="mb-3">
        <small class="breadcrumb" style="gap:4px; font-size:100%;">
            <a href="/">Trang chủ</a> <span>/</span> <span> Đặt hàng</span>
        </small>
    </div>
    ...
    <div class="table-responsive shadow-sm p-3 bg-light border rounded">
            ...
            <table class="table table-bordered align-middle text-center">
                ...
                <tbody>
                    ...
                    @if($GiamGia>0)
                    <tr>
                        <th colspan="5" class="text-right">{{ $TenKhuyenMai }}</th>
                        <th colspan="2"style="color: green; font-weight: bold;">{{ number_format($cart->tongtien * ($GiamGia / 100), 0, ',', '.') }} VND</th>
                    </tr>
                @endif
                            <tr>
