...
<body>
  <div class="container">
      ...
      <div class="mb-3">
        <div class="breadcrumb" style="gap:4px; font-size:100%">
             <a href="{{ route('client.home') }}">Trang chủ</a> /
           <a href="{{ route('sanpham.index') }}">Sản phẩm</a> /
        <span>{{ $product->LoaiSanpham->TenLoaiSanPham .' - '.$product->TenGoi }}</span>
        </div>
    </div>
    ...
    <button type="button" class="btn-increase">+</button>
            ...
            <div>
             ...
             type="submit" class="btn-primary add-to-cart" style="width:250px;border-radius:4px">THÊM VÀO ĐẶT HÀNG</button>
              @endif
            </div>
          </form> 
          @endif
