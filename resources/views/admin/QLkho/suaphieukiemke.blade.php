    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('QLphieukiemke.update', $phieukiemke->id) }}" method="POST" id="formPhieuNhap">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="NguoiKiemKe" name="NguoiKiemKe" class="form-control" required value="{{ isset($phieukiemke) ? $phieukiemke->NguoiKiemKe : '' }}">
                        </div>
                        <div class="mb-3">
        ...
        <div class="col-md-6 mb-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ isset($sanpham) ? route('QLctsuakkiemke.update', $key) : route('QLctsuakkiemke.store') }}" method="POST">
                        @csrf
                        @if (isset($sanpham))
                            @method('PUT')
                        @endif
                        ...
                        @if(isset($sanpham))
                            <a href="{{ route('QLctsuakkiemke.create') }}" class="btn btn-secondary">Hủy</a>
                        @endif
                    </form>
                </div>
            </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-striped table-hover mb-0">
                    ...
                    <tbody>
                        @php
                            $chiTietTemp = session('sua_chi_tiet_kiemke',[]);
                        @endphp
                            ...
                            @foreach($chiTietTemp as $index => $item)
                                ...
                                <td class="text-center">{{ $index + 1 }}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('QLctsuakkiemke.edit',$index) }}" class="btn btn-warning btn-sm">
                                            <i class="fas fa-edit"></i> Sửa
                                        </a>
                                        <form action="{{ route('QLctsuakkiemke.destroy', $index) }}" method="POST" class="d-inline" onsubmit="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');">
                                            @csrf
                                            @method('DELETE')
