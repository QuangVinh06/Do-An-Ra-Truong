            ...
            <div class="filters-row">
                <div class="filter-item">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="{{ route('baocaosanpham', request()->query()) }}" target="_blank">
                            <button type="button" class="btn btn-outline-blue">Xuất PDF</button>
                        </a>
                    </div>
                </form>
        ...
        <div class="dashboard">
            ...
            <div class="card">
                ...
                @if ($sanPhamBanChay->first())
                    <div class="card-value" style="font-size: 18px;">{{ $sanPhamBanChay->first()->TenGoi }}</div>
                    <div class="card-trend"> {{ $sanPhamBanChay->first()->tong_so_luong }} sản phẩm đã bán</div>
                @else
                    <div class="card-value" style="font-size: 18px;">Không có dữ liệu</div>
                @endif
            </div>
        </div>
