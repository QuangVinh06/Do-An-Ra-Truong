...
<div class="mb-2">
    ...
    <input type="text" name="id" class="form-control" placeholder="Nhập mã khuyến mãi" value="{{ $khuyenmai->id ?? '' }}" 
        @if(isset($khuyenmai)) readonly @endif>
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('QLkhuyenmai.destroy', $km->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa khuyến mãi này?');">
                        @csrf
                        @method('DELETE')
