...
class ProductController extends Controller
{
    ...
    public function baoCaoSanPham(Request $request)
    {
        ...
        ->join('phieu_dat_hang', 'chi_tiet_phieu_dat_hang.idPhieuDatHang', '=', 'phieu_dat_hang.id')
        ...
        ->join('bang_gia', 'bang_gia.idSanPham', '=', 'san_phams.id') // thêm bảng giá
        ->select(
            'san_phams.id',
            'san_phams.TenGoi',
            'san_phams.MoTa',
            ...
            DB::raw('SUM(chi_tiet_phieu_dat_hang.ThanhTien - chi_tiet_phieu_dat_hang.SoLuong * bang_gia.Gia) as loi_nhuan')
        );
