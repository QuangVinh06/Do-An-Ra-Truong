...
class HopDongController extends Controller
{
    ...
    public function tongsohopdong(){
        $tongsohopdong = HopDong::whereYear('NgayLap', 2025)->count();
       dd($tongsohopdong);
        return view('admin.hopdong.tongsohopdong', compact('tongsohopdong'));  
     }
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'NgayLap.required' => 'Ngày lập hợp đồng là bắt buộc.',
            'ThoiGianKetThuc.required' => 'Thời gian kết thúc hợp đồng là bắt buộc.',
            'NgayGiaoHang.required' => 'Ngày giao hàng là bắt buộc.',
            'NguoiGiaoHang.required' => 'Người giao hàng là bắt buộc.',
            'Thue.required' => 'Thuế là bắt buộc.',
            'idPhieuDat.required' => 'Phiếu đặt hàng là bắt buộc.',
            'FileHopDong.required' => 'File hợp đồng là bắt buộc.',
            'FileHopDong.mimes' => 'File hợp đồng phải là định dạng pdf, doc hoặc docx.',
            'NgayGiaoHang.after' => 'Ngày giao hàng phải sau ngày lập hợp đồng.',
            'ThoiGianKetThuc.after' => 'Thời gian kết thúc hợp đồng phải sau ngày lập hợp đồng.',
        ]);
        ...
        if ($hopDong) {
            ...
            return redirect()->route('QLhopdong.index')->with('success', 'Thêm hợp đồng  thành công');
        }
    ...
    {
        $hds = HopDong::with(['phieuDatHang'])->paginate(10);
