                    ...
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                            ...
                            <tr class="total-row">
                                ...
                                @php
                                $loaiKH = optional($dh->hopDong->phieuDatHang->loaiKhachHang);
                                $khuyenMai = optional($loaiKH->khuyenMai);
                            @endphp
                            ...
                            <td colspan="3" class="text-end">
                                @if ($loaiKH)
                                    <strong>
                                        ...
                                        @if ($khuyenMai && $khuyenMai->GiamGia > 0)
                                            - Giảm {{ $khuyenMai->GiamGia }}%
                                        @else
                                            - Không có khuyến mãi
                                        @endif
                                    </strong>
                                @else
                                    <strong>Không xác định loại khách hàng</strong>
                                @endif
                            </td>
