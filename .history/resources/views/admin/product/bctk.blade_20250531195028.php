        ...
        <div class="product-stats">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <div>
                        <h4>{{ $sp->TenGoi }}</h4>
                        <p>Số lượng bán: {{ $sp->tong_so_luong }}</p>
                        <p>Tổng tiền: {{ number_format($sp->tong_tien, 0, ',', '.') }} VND</p>
                        <p>Loại: {{ $sp->loaiSanPham->TenLoai ?? 'Không rõ' }}</p>
                        <p>Đơn vị tính: {{ $sp->DonViTinh->TenDonVi ?? 'Không rõ' }}</p>
                        <p>Màu: {{ $sp->Mau->TenMau ?? 'Không rõ' }}</p>
                    </div>
                @endforeach
                </tbody>
            </table>
