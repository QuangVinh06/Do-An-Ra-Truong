                    ...
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                             <tr class="total-row">
                                ...
                                $tienGiam= $dh->hopDong->phieuDatHang->chiTietPhieuDat->sum('ThanhTien')-$dh->hopDong->phieuDatHang->TongTien;
                                 @endphp


                                <td colspan="3" class="text-end">
                                    <strong>{{ number_format($tienGiam) }} VND</strong>                                        
                                </td>   
                            </tr>
                            <tr class="total-row">
                            <td colspan="3" class="text-end">
                            ...
                            <tr class="total-row">
                                ...
                                <td colspan="3" class="text-right">
                                    <strong id="totalAmount">{{ $dh->hopDong->GiaTriGocHopDong }}</strong>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
