...
<div class="container">
    ...
    <div class="page-header">
        @if ($khachHang)
            <h2 class="page-title">
                Đơn hàng của khách hàng: <span class="customer-name">{{ $khachHang->user->name }}</span>
            </h2>
        @else
    ...
    @if($donHangs->count() > 0)
        <div class="orders-container">
                    ...
                    <tbody>
                        @foreach ($donHangs as $donHang)
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="total-amount">{{ number_format($donHang->TongTienThanhToan, 0, ',', '.') }}đ</span>
                                </td>
                                <td>
            ...
            <div class="summary-info">
                <span class="total-orders">Tổng cộng: {{ $donHangs->count() }} đơn hàng</span>
                <span>Tổng giá trị: {{ number_format($donHangs->sum('TongTienThanhToan'), 0, ',', '.') }}đ</span>
            </div>
        </div>
    @else
        <div class="orders-container">
