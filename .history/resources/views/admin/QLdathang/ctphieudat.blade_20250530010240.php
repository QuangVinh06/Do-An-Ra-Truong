...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('qlphieudat.index') }}" class="btn btn-outline-secondary rounded-pill shadow-sm">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
                ...
                <table class="table table-striped table-hover align-middle shadow-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-start">{{ $ct->sanPham->TenGoi }}</td>
                            <td class="text-center">{{ $ct->SoLuong }}</td>
                            <td class="text-end">{{ number_format($ct->DonGia, 0, ',', '.') }}đ</td>
                            <td class="text-end text-primary fw-bold">{{ number_format($ct->ThanhTien, 0, ',', '.') }}đ</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="text-end mt-3">
                <h5 class="fw-semibold">Tổng tiền: 
                    <span class="text-danger">
                        {{ number_format($ctdat->sum('ThanhTien'), 0, ',', '.') }}đ
                    </span>
                </h5>
            </div>
        </div>
