...
<body>
    ...
    <div class="container">
        <h1>Chi tiết phiếu đổi trả</h1>
              <a href="{{ url()->previous() }}" class="btn btn-outline-secondary">Quay lại</a>        <hr>        
        ...
        <div class="form-section">
            <div class="customer-info">
                ...
                <br>
                    ...
                    <p>Tên khách hàng:{{ $doitra->khachHang->user->name ?? '' }} </p>
                    <p>Số điện thoại:{{ $doitra->khachHang->SoDienThoai ?? '' }}</p> 
                    <p>Emai:{{ $doitra->khachHang->user->email ?? '' }}</p>
                </div>
