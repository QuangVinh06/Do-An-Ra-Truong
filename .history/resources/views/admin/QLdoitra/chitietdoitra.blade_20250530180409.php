        ...
        <div class="form-section">
            <div class="customer-info">
                <div class="form-group">
                    <label for="customerName">Mã đơn hàng:</label>
                    <input type="text" id="customerName"value={{$doitra->donHangs->id }} readonly>
                </div>
                <div class="form-group">
                    <label for="customerName">Tên khách hàng:</label>
                    <input type="text" id="customerName"value={{$doitra->khachHang->user->name }} readonly>
                </div>
