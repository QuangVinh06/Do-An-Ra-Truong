...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        @endforeach
                    <div class="col-md-3 mb-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="routes[]" value="QLKhachHang.baocao,QLKhachHang.xemctdonhang,QLKhachHang.donhang"
                    ...
                    <div class="col-md-3 mb-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="routes[]" value="QLdonhang.baocao,QLdonhang.thanhtoan,"
                    ...
                    <div class="col-md-3 mb-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="routes[]" value="QLsanpham.baoCaoSanPham"
                    ...
                    <div class="col-md-3 mb-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="routes[]" value="QLchitietkho.baocao"
