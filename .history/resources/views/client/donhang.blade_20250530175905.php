...
<div class="container py-4">
    <!-- Tiêu đề trang -->
    <button class="btn-doi-tra" style=" background-color:rgb(15, 153, 10);  color: #fff;border: none; padding: 10px 20px;border-radius: 5px;  font-size: 16px; cursor: pointer;  transition: background-color 0.3s ease; ">Trang đổi trả</button>
    <hr>
    <!-- Bảng đơn hàng -->
