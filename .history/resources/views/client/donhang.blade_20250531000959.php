...
<div class="container py-4">
    <!-- Tiêu đề trang -->
    <a class="btn-doi-tra" style=" background-color:rgb(15, 153, 10);  color: #fff;border: none; padding: 10px 20px;border-radius: 5px;  font-size: 16px; cursor: pointer;  transition: background-color 0.3s ease; "href="{{ route('client.doitra2') }}">Trang đổi trả</a>
    <hr>
    <!-- Bảng đơn hàng -->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="">
                                ...
                                {{ $dh->TrangThai === 'Đã giao hàng' ? 'bg-success text-white' : 'bg-secondary text-white' }}">
                            ...
                            <td class="text-center">
                                ...
                                @if($dh->TrangThai === 'Đã thanh toán toàn bộ'||$dh->TrangThai === 'Đã giao hàng')<a href="{{ route('QLdoitra.create', $dh->id) }}" class="btn btn-sm btn-primary">Đổi trả</a>
                                @endif
                            </td>
                        </tr>
                        @empty
