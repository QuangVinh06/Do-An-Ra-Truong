...
@section('main')
<div class="container"> <!-- Thêm container để canh giữa toàn bộ -->
    <div class="card-body">
        <a href="{{ route('thanhtoan.index') }}" class="btn btn-outline-secondary">Quay lại</a>
        <hr>
        <div class="row mb-5 justify-content-center"> <!-- Căn giữa các card -->
            <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <p class="mb-0">
                                ...
                                <span class="text-success fw-bold">{{ number_format($hd->GiaTriGocHopDong, 0, ',', '.') }} đ</span>
                            </p>
                            <p class="mb-0">
                                <strong class="text-secondary">Số tiền còn lại cần thanh toán:</strong>
                                <span class="text-success fw-bold">{{ number_format($hd->TongSoTienConLai, 0, ',', '.') }} đ</span>
                            </p>
                            <p class="mb-0">
                                <strong class="text-secondary">Phương thức thanh toán:</strong>
                                <span class="text-success fw-bold">{{ $hd->phieuDatHang->phuongthuc->TenPhuongThucThanhToan }}</span>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="table-responsive mx-auto" style="max-width: 900px;"> <!-- Canh giữa bảng -->
