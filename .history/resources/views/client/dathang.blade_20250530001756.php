            ...
            <table class="table table-bordered align-middle text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th colspan="2"style="color: green; font-weight: bold;">{{ number_format($cart->tongtien, 0, ',', '.') }} VND</th>
                    </tr>
                    @if($GiamGia>0)
                    <tr>
                        <th colspan="5" class="text-right">{{ $GiamGia->TenKhuyenMai }}</th>
                        <th colspan="2">{{ number_format($cart->tongtien * ($GiamGia / 100), 0, ',', '.') }} VND</th>
                    </tr>
                @endif
                            <tr>
                        <th colspan="5" class="text-right">Tổng tiền thanh toán</th>
                        <th colspan="2"style="color: green; font-weight: bold;">{{ number_format($cart->tongtien - ($cart->tongtien * ($GiamGia / 100)), 0, ',', '.') }} VND</th>
