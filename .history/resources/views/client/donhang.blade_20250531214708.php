            ...
            <table class="classic-table">
                <thead>
                    <tr>
                        ...
                        <th width="18%" text-center>Trạng thái</th>
                ...
                <tbody>
                    ...
                    <tr class="table-row">
                        ...
                        <td>
                            <span class="amount-classic">{{ number_format($dh->TongTienThanhToan, 0, ',', '.') }} đ</span>
                        </td>
                        <td class="text-center">
                            <div class="action-group">
                                ...
                                @if($dh->TrangThai === 'Đã thanh toán toàn bộ' || $dh->TrangThai === 'Đa giao hàng')
