...
<div class="container py-4">
    <!-- Tiêu đề trang -->
    <a class="btn-doi-tra" style=" background-color:rgb(15, 153, 10);  color: #fff;border: none; padding: 10px 20px;border-radius: 5px;  font-size: 16px; cursor: pointer;  transition: background-color 0.3s ease; "href="{{ route('client.doitra2', ['id' => $donHang->id]) }}">Trang đổi trả</a>
    <hr>
    <!-- Bảng đơn hàng -->
