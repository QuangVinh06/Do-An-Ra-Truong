...
use App\Http\Controllers\BaoCao\BaoCaoBanHang;
...
Route::group(['prefix' => 'admin', 'middleware'=>'check'], function(){
    ...
    Route::get('/bao-cao-thong-ke-khach-hang/donhang/{email}', [QLKhachHang::class, 'xemDonHang'])->name('QLKhachHang.donhang');
    Route::get('/bao-cao-thong-ke-khach-hang/ctdonhang/{id}', [QLKhachHang::class, 'xemctDonHang'])->name('QLKhachHang.xemctdonhang');

    Route::get('/bao-cao-thong-ke-san-pham-ct', [ProductController::class, 'baoCaoSanPham'])->name('QLsanpham.baoCaoSanPham');
  ...
  Route::resources([
    ...
    Route::get('/download', [BaoCaoBanHang::class, 'download'])->name('baocaobanhang');
    Route::get('/download-khachhang', [BaoCaoBanHang::class, 'download1'])->name('baocaokhachhang');
    Route::get('/bao-cao-thong-ke-khach-hang/donhang/{email}/download',[BaoCaoBanHang::class, 'download2'])->name('baocaodonhang');
    Route::get('/download-sanpham', [BaoCaoBanHang::class, 'download3'])->name('baocaosanpham');
    Route::get('tongsohopdong',[HopDongController::class,'tongsohopdong'])->name('tongsohopdong');

    Route::get('/download-kho',[BaoCaoBanHang::class,'download4'])->name('baocaokho');
});
...
Route::group(['prefix' => ''], function () {
  ...
  Route::get('/xemdoitra', [QLdoitra::class, 'doitra2'])->name('client.doitra2');
  Route::get('/admin/QLdoitra/xacnhan/{id}', [QLdoitra::class, 'xacNhan'])->name('phieuDoiTra.xacnhan');
  Route::get('/doitra2/{id}', [QLdoitra::class, 'show2'])->name('QLdoitra.show2');
  Route::get('/doitra/{id}', [QLdoitra::class, 'show'])->name('QLdoitra.show');
